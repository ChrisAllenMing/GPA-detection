...
# define the sim10k dataset for vehicle detection
class sim10k(imdb):
    def __init__(self, image_set, num_shot = None):
        imdb.__init__(self, 'sim10k_' + image_set)
        self.num_shot = num_shot
        self._image_set = image_set
        self._data_path = os.path.join('data', 'sim10k')
    ...
    def _get_default_path(self):
        """
        Return the default path where sim10k is expected to be installed.
        """
    ...
    def gt_roidb(self):
        ...
        gt_roidb = [self._load_sim10k_annotation(index)
    ...
    def _load_sim10k_annotation(self, index):
        """
