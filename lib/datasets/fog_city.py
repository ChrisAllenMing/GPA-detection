...
# define the foggy cityscapes for multi-class detection
class fog_city(imdb):
    def __init__(self, image_set, num_shot=None):
        imdb.__init__(self, 'fog_city_' + image_set)
        self.num_shot = num_shot
        self._image_set = image_set
        self._data_path = os.path.join('data', 'fog_city')
    ...
    def _get_default_path(self):
        ...
        """
        return os.path.join(cfg.DATA_DIR, 'fog_city')
    ...
    def _load_city_annotation(self, index):
        ...
        format.
        """
        filename = os.path.join(self._data_path, 'anno_' + self._image_set, index + '.xml')
