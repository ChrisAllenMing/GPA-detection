...
if __name__ == '__main__':
    ...
    for i in range(num_images):
        ...
        rpn_loss_cls, tgt_rpn_loss_cls, rpn_loss_box, tgt_rpn_loss_box, \
        RCNN_loss_cls, tgt_RCNN_loss_cls, RCNN_loss_bbox, tgt_RCNN_loss_bbox, \
        RCNN_loss_intra, RCNN_loss_inter, rois_label, tgt_rois_label, _, _ = fasterRCNN(im_data, im_info, gt_boxes,
                                                                                  num_boxes, im_data, im_info,
                                                                                  gt_boxes, num_boxes)
